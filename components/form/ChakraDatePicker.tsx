...
const MONTH_NAMES_DEFAULT = ['Led', 'Úno', 'Bře', 'Dub', 'Kvě', 'Čer', 'Čvc', 'Srp', 'Zář', 'Říj', 'Lis', 'Pro'];
const DAY_NAMES_DEFAULT = ['Ne', 'Po', 'Út', 'St', 'Čt', 'Pá', 'So'];
...
const SingleDatepickerCalendar = (props: RenderProps & { configs: SingleDatepickerConfigs }) => {
